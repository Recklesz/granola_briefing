...
- fill the editorial JSON contract directly instead of relying on client-side data reshaping
...
4. Build a structured editorial JSON payload and save it to a temp file.
